...
const MenuBar = () => {
    ...
    return (
        <S.MenuBarWrapper>
            <S.MenuBarGroup>
                <S.MenuBarLink to="/" cover direction="left" bg="#16202c" duration={0.6} title="Voltar para Home">
                    <S.MenuBarItem><Home /></S.MenuBarItem>
                </S.MenuBarLink>
                <S.MenuBarLink to="/search/" cover direction="left" bg="#16202c" duration={0.6} title="Pesquisar">
            ...
            <S.MenuBarGroup>
                ...
                }}>{isListMode ? <Grid /> : <List />}</S.MenuBarItem>
